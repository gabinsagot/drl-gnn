...
class Foil:
    ...
    def __init__(self, number_of_points, chord_length, thickness):
        self.msh_size = 0.01
        self.type = "bezier"
    ...
    def get_t(self) -> None:
        ...
        print("Created t_file... Waiting to be filled")
...
TEST4 = 0
if TEST4:
    airfoil = Foil(10, 1.0, 1.0, "modif_test")
    
    airfoil.plot()
    airfoil.number_of_points = len(airfoil.points)
    airfoil.name = f"modif_test"
    airfoil.translate(4,2)
    airfoil.sync()
