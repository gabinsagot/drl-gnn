...
def compute_foil_points(init_naca, end_naca, ep : int, base_folder : str, path_to_results : str, interp_type = "bezier", density = 100, p = 6, a=1e-10):
    """
    ...
    return init_cp + displacements # type: ignore  
